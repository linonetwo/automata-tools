...
def NFAtoDFAGroupStable(nfa: Automata) -> Automata:
    """
    While transform NFA to DFA, it will try to keep group stable, won't mix the state within them with the states outside the group. So you can know when this automata is catching a group.
